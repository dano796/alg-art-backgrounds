...
export function Footer() {
  return (
    <footer className="border-t border-border px-10 py-7 flex items-center justify-between flex-wrap gap-4 bg-surface">
      {/* Brand */}
      <div className="flex items-center gap-2.5">
        <div className="w-6 h-6 rounded-md bg-accent flex items-center justify-center text-[12px] font-bold text-white font-display">
          A
        </div>
